低代码平台到底怎么选？到了 2025 年，这条赛道已经卷出了门道。从“搭建一个系统”到“构建一套体系”，不少开发者开始意识到：只是做得快还不够，能不能复用、能不能沉淀、能不能产品化，才是能不能走得远的关键。现在市面上各种平台层出不穷，有的主打页面搭建，有的专注流程编排，也有不少平台开始往“标准化交付”这条路上走。本文整理了当前主流国内低代码平台，按类型分组，附带开源仓库、官方链接和背景资料，方便快速查阅和选型比对。如果你关心的不只是开发效率，而是怎么搭出一个能复制、能演进的产品体系，那这份清单值得收藏。
